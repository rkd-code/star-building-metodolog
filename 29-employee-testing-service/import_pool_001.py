...
def add_report_sheet(wb, questions):
    ...
    rows = [
        ...
        ["Назначение по должностям", "не указано"],
...
def build_bank(questions):
    ...
    for q in questions:
        ws.append([
            ...
            "не указан (исходный DOCX)", "не указано", None,
        ])
    update_table_ref(ws)
    ...
    ws = wb["Программы"]
    ws.append(["ПРОГ-ПУЛ-001", "Комплексное тестирование сотрудников Star Building", "не указано", "Все темы пула 001", 102, None, None, None, None, "Черновик", "0.1"])
    update_table_ref(ws)
