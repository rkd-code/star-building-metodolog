...
HEADERS = {
    ...
    "Программы": ["Код программы", "Название", "Официальные должности", "Темы", "Число вопросов", "Время, минут", "Порог, %", "Попыток", "Период попыток", "Срок действия результата", "Статус", "Версия"],
